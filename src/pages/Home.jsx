...
export default function Home() {
  ...
  return (
    <div className="page home-page">
      ...
      <Link to="/inspiration" className={`selfcare-card ${visible ? 'visible' : ''}`}>
        <span className="selfcare-icon">🌬️</span>
        <span className="selfcare-title">רגע לעצמי</span>
        <span className="selfcare-text">תרגיל נשימות קצר להרגעה — גם לכם מגיע רגע</span>
      </Link>
    </div>
  )
}
