  ...
  return (
    <div className="landing-page" onClick={() => navigate('/home')}>
      <div className={`landing-content ${visible ? 'visible' : ''}`}>
        ...
        <p className="landing-intro">הורים יקרים, שמחים להציג לכם את האתר החדש של גן דגנית! האתר נבנה עבורכם כדי לחזק את הקשר בין הגן לבית — תמצאו בו מידע שוטף, עדכונים ותכנים שיעזרו לכם להמשיך את העבודה המשותפת גם בבית. מוזמנים להיכנס ולהשתמש באופן שוטף, כי החיבור והתיאום ביננו הם הכוח שמניע אותם קדימה.</p>
